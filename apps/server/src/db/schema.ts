...
export const postAnalyses = sqliteTable("post_analyses", {
  ...
  headlineScore: integer("headline_score"),
  readabilityScore: integer("readability_score"),
  valueScore: integer("value_score"),
  originalityScore: integer("originality_score"),
  searchFitScore: integer("search_fit_score"),
  qualityScore: integer("quality_score"),
  qualityStatus: text("quality_status"),
  signalBreakdownJson: text("signal_breakdown_json"),
  contentMetricsJson: text("content_metrics_json"),
  scoreDriversJson: text("score_drivers_json"),
  scoreRisksJson: text("score_risks_json"),
